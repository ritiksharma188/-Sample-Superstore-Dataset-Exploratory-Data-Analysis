...
ggplot(data=SampleSuperstore, aes(Profit,Discount)) +
  ...
  labs(title = " Profit and Discount Negative Correlation")

ggplot(data=SampleSuperstore, aes(Sales,Discount,fill=Segment)) +
  geom_point() +
  # Add a regression line
  geom_smooth(method = "lm", se = TRUE, color = "red")+
  labs(title = " Sales and Discount Positive Correlation")
